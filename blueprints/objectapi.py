...
from consultas import get_sparq_obj, get_prefix  # Importe suas funções corretamente
...
def adicionar_objeto_fisico():
    try:
        ...
        required_fields = ['description', 'title', 'content_urls', 'depictions', 'physical_type']
